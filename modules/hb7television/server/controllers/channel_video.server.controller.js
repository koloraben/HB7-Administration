...
exports.create = function (req, res) {
    ...
    req.body.channelDay.broadcast_day = moment(req.body.channelDay.broadcast_day,"DD-MM-yyyy")
    var videos = req.body.videos;
    var channelDay = req.body.channelDay;
    console.log("req.body.channelDay :",req.body.videos[0])
    DBModel.create(req.body.channelDay).then(function (channelDay) {
        var VideoDay = []
        var videoBegin = []
        for(let i in videos){

...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';
	var myApp = angular.module('myApp', ['psi.sortable', 'moment-picker', 'ng-admin', 'angularMoment', 'ngFileUpload', 'daypilot', 'ng-admin.jwt-auth', 'ngVis', 'pascalprecht.translate', 'ngCookies', 'dndLists']);
	...
	myApp.controller('DemoCtrl', ['$scope', '$http', function ($scope, $timeout, $http) {
	    ...
	    $scope.weekConfig = {
	        ...
	        onEventClicked: function onEventClicked(args) {
	            console.log("Event clicked: " + args.e.start());
	        },
	        onEventDeleted: function onEventDeleted(args) {
	...
	myApp.directive('approveReview', __webpack_require__(144));
	
	//myApp.directive('roles', require('./grouprights/radioRoles'));
	
	// personal config
	myApp.config(['$stateProvider', __webpack_require__(145)]);
	myApp.config(['$stateProvider', __webpack_require__(147)]);
	myApp.config(['$stateProvider', __webpack_require__(149)]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _userDetailsHtml = __webpack_require__(146);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _changePasswordHtml = __webpack_require__(148);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _epgchartHtml = __webpack_require__(150);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    }).label('Card *'), nga.field('background', 'file').uploadInformation({ 'url': '/file-upload/single-file/channels/background', 'apifilename': 'result' }).template('<div class="row">' + '<div class="col-xs-12 col-sm-1"><img src="{{ entry.values.background }}" height="40" width="40" /></div>' + '<div class="col-xs-12 col-sm-8"><ma-file-field field="field" value="entry.values.background"></ma-file-field></div>' + '</div>' + '<div class="row"><small id="emailHelp" class="form-text text-muted">pr�f�rable de 1920x1200 px</small></div>').validation({
	        validator: function validator(value) {
	            if (value == null) {
	                throw new Error('Please, choose background');
	            }
	        }
	    }).label('Background *'), nga.field('template').label('').template(_edit_buttonHtml2['default'])]);
	    ...
	    }).label('Icon *'), nga.field('background', 'file').uploadInformation({ 'url': '/file-upload/single-file/channels/background', 'apifilename': 'result' }).template('<div class="row">' + '<div class="col-xs-12 col-sm-1"><img src="{{ entry.values.background }}" height="40" width="40" /></div>' + '<div class="col-xs-12 col-sm-8"><ma-file-field field="field" value="entry.values.background"></ma-file-field></div>' + '</div>' + '<div class="row"><small id="emailHelp" class="form-text text-muted">pr�f�rable de 1920x1200 px</small></div>').validation({
	        validator: function validator(value) {
	            if (value == null) {
	                throw new Error('Please, choose background');
	            }
	        }
	    }).label('Background *'), nga.field('template').label('').template(_edit_buttonHtml2['default']), nga.field('ChannelStreams', 'referenced_list').label('Channel Streams').targetEntity(admin.getEntity('ChannelStreams')).targetReferenceField('channel_id').targetFields([nga.field('stream_url')
	    // .map(function truncate(value) {
	    // 	if (!value) {
	    // 		return '';
	    // 	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    devicemenu.listView().title('<h4>Main Menu <i class="fa fa-angle-right" aria-hidden="true"></i> List</h4>').batchActions([]).fields([nga.field('icon_url', 'file').template('<img src="{{ entry.values.icon_url }}" height="42" width="45" />').cssClasses('hidden-xs').label('Icon'), nga.field('title', 'string').isDetailLink(true).label('Title'), nga.field('url').map(function truncate(value) {
	        ...
	        return value.length > 25 ? value.substr(0, 25) + '...' : value;
	    }).cssClasses('hidden-xs').label('Url'), nga.field('menu_code', 'choice').attributes({ placeholder: 'Menu Code' }).choices([{ value: 0, label: 'Url' }, { value: 1, label: 'Live TV' }, { value: 2, label: 'EPG' }, { value: 3, label: 'Logout' }, { value: 4, label: 'Apps' }, { value: 8, label: 'Webview Url' }, { value: 10, label: 'Network Test' }, { value: 11, label: 'Vod' }, { value: 12, label: 'Application menu' }, { value: 20, label: 'Personal' }, { value: 21, label: 'Catchup' }]).validation({ required: true }).label('Menu Code'), nga.field('position', 'string').label('Position'), nga.field('appid', 'template').map(function toarray(value) {
	        var thearray = JSON.parse("[" + value + "]");
	        var returnobj = {};
	        thearray.forEach(function (element) {
	            returnobj[element] = appids[element];
	    ...
	    }).label('Icon *'), nga.field('menu_code', 'choice').attributes({ placeholder: 'Choose from dropdown list the type of main menu item you are creating' }).choices([{ value: 0, label: 'Url' }, { value: 1, label: 'Live TV' }, { value: 2, label: 'EPG' }, { value: 3, label: 'Logout' }, { value: 4, label: 'Apps' }, { value: 8, label: 'Webview Url' }, { value: 10, label: 'Network Test' }, { value: 11, label: 'Vod' }, { value: 12, label: 'Application menu' }, { value: 20, label: 'Personal' }, { value: 21, label: 'Catchup' }]).validation({ validator: function validator(value) {
	            if (value === null || value === '') {
	                throw new Error('Please Select Menu Code');
	            }
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    devices.listView().title('<h4>Devices <i class="fa fa-angle-right" aria-hidden="true"></i> List</h4>').batchActions(['<sendpush type="softwareupdate" selection="selection"></sendpush>', '<sendpush type="deletedata" selection="selection"></sendpush>', '<sendpush type="deletesharedpreferences" selection="selection"></sendpush>']).actions(['batch', 'export', 'filter', 'create']).fields([nga.field('device_id', 'string').label('Device ID'), nga.field('device_mac_address', 'string').label('Mac Address'), nga.field('device_brand').label('Device Brand'), nga.field('device_active', 'boolean').label('Device Active'), nga.field('createdAt', 'datetime').label('First Login'), nga.field('updatedAt', 'datetime').label('Last Login')]).filters([nga.field('q').label('').template('<div class="input-group"><input type="text" ng-model="value" placeholder="Search" class="form-control"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span></div>').pinned(true), nga.field('device_active', 'boolean').filterChoices([{ value: true, label: 'Active' }, { value: false, label: 'Not Active' }]).label('Device Active'), nga.field('device_mac_address').attributes({ placeholder: 'Device Mac Address' }).label('Device Mac Address'), nga.field('device_id').attributes({ placeholder: 'Device ID' }).label('Device ID'), nga.field('device_brand').attributes({ placeholder: 'Device Brand' }).label('Device Brand')]).listActions(['edit']).exportFields([devices.listView().fields()]);
	
	    devices.creationView().title('<h4>Devices <i class="fa fa-angle-right" aria-hidden="true"></i> Create: Device</h4>').onSubmitSuccess(['progression', 'notification', '$state', 'entry', 'entity', function (progression, notification, $state, entry, entity) {
	        progression.done();
	        $state.go($state.get('edit'), { entity: entity.name(), id: entry._identifierValue });
	        return false;
	    }]).fields([nga.field('device_active', 'boolean').validation({ required: true }).label('Device Active'), nga.field('device_mac_address', 'string').attributes({ placeholder: 'Device Mac Address' }).validation({ required: true }).editable(true).label('Device Mac Address'), nga.field('device_id', 'string').attributes({ placeholder: 'Device ID' }).validation({ required: true }).editable(true).label('Device ID'), nga.field('firmware', 'string').editable(true).label('Firmware'), nga.field('os').editable(true).label('Os'), nga.field('device_brand').editable(true).label('Device Brand'), nga.field('template').label('').template(_edit_buttonHtml2['default'])]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    logindata.listView().title('<h4>Login Accounts <i class="fa fa-angle-right" aria-hidden="true"></i> List</h4>').batchActions([]).fields([nga.field('customer_id', 'reference').targetEntity(admin.getEntity('CustomerData')).targetField(nga.field('firstname').map(function (value, entry) {
	        return entry.firstname + ' ' + entry.lastname;
	    })).cssClasses('hidden-xs').label('Customer'), nga.field('device_id', 'reference').targetEntity(admin.getEntity('Devices')).targetField(nga.field('device_id')).cssClasses('hidden-xs').label('Device'), nga.field('code').label('Code'), nga.field('account_lock', 'boolean').cssClasses('hidden-xs').label('Account Locked')]).filters([nga.field('q').label('').template('<div class="input-group"><input type="text" ng-model="value" placeholder="Search" class="form-control"></input><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span></div>').pinned(true)]).listActions(['edit']);
	    ...
	    }), nga.field('device_id', 'reference').targetEntity(admin.getEntity('Devices')).targetField(nga.field('device_id').map(function (v, e) {
	        return "id: " + e.device_id;
	    })).remoteComplete(true, {
	        refreshDelay: 300,
	        // populate choices from the response of GET
	        searchQuery: function searchQuery(search) {
	    ...
	    .attributes({ placeholder: 'Select Device' }).label('Device *').validation({ validator: function validator(value) {
	            if (value === null || value === '') {
	                throw new Error('Please Select Customer');
	            }
	        }
	    }), nga.field('code').attributes({ placeholder: 'Code' }).validation({ required: true }).editable(true).label('Code'), nga.field('account_lock', 'choice').defaultValue(false).choices([{ value: false, label: 'Disabled' }, { value: true, label: 'Enabled' }]).attributes({ placeholder: 'Choose from dropdown list' }).label('Account Locked').validation({ required: true }), nga.field('template').label('').template(_edit_buttonHtml2['default'])]);
	    ...
	    }), nga.field('device_id', 'reference').targetEntity(admin.getEntity('Devices')).targetField(nga.field('device_id', 'template').map(function (v, e) {
	        return "id: " + e.device_id;
	    })).attributes({ placeholder: 'Select Device' }).label('Device *').perPage(10).validation({ validator: function validator(value) {
	            if (value === null || value === '') {
